...
<head>
  ...
  <title>Dashboard | Ranisa Chicken</title>
    ...
    <div class="d-flex" id="wrapper" data-aos="fade-right">
      ...
      <div class="border-right" id="sidebar-wrapper">
        <div class="sidebar-heading text-center">
          <img src="../images/logo ranisa.webp" alt="" class="my-4 w-50" />
        </div>
        <div class="list-group list-group-flush">
          <a href="?page=dashboard" class="list-group-item list-group-item-action<?= $page == 'dashboard' ? ' active' : ''; ?> <?= $page == '' ? ' active' : ''; ?>">
            Dashboard
          </a>
          <a href="?page=products" class="list-group-item list-group-item-action<?= $page == 'products' ? ' active' : ''; ?> <?= $page == 'products-create' ? ' active' : ''; ?> <?= $page == 'products-details' ? ' active' : ''; ?>">
            Products
          </a>
          <a href="?page=galleries" class="list-group-item list-group-item-action<?= $page == 'galleries' ? ' active' : ''; ?> <?= $page == 'galleries-create' ? ' active' : ''; ?> <?= $page == 'galleries-details' ? ' active' : ''; ?>">
            Galleries
          </a>
          <a href="?page=categories" class="list-group-item list-group-item-action<?= $page == 'categories' ? ' active' : ''; ?> <?= $page == 'categories-create' ? ' active' : ''; ?> <?= $page == 'categories-details' ? ' active' : ''; ?> <?= $page == 'categories-delete' ? ' active' : ''; ?>">
            Categories
          </a>
          <div class="dropdown">
          ...
          <a href="?page=rekening" class="list-group-item list-group-item-action<?= $page == 'rekening' ? ' active' : ''; ?> <?= $page == 'rekening-create' ? ' active' : ''; ?> <?= $page == 'rekening-details' ? ' active' : ''; ?>">
            Rekening
          </a>
          <a href="?page=drivers" class="list-group-item list-group-item-action<?= $page == 'drivers' ? ' active' : ''; ?> <?= $page == 'drivers-create' ? ' active' : ''; ?> <?= $page == 'drivers-details' ? ' active' : ''; ?> <?= $page == 'drivers-delete' ? ' active' : ''; ?>">
            Drivers
          </a>
          <a href="?page=users" class="list-group-item list-group-item-action<?= $page == 'users' ? ' active' : ''; ?> <?= $page == 'users-create' ? ' active' : ''; ?> <?= $page == 'users-details' ? ' active' : ''; ?>">
            Users
          </a>
          <a href="?page=logout" class="list-group-item list-group-item-action<?= $page == 'logout' ? ' active' : ''; ?>">
            Sign Out
          </a>
        </div>
      </div>
