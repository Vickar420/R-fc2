...
<head>
  ...
  <title>About - Ranisa Chicken</title>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            <h1 class="" style="font-size: 60px;">Ranisa Fried Chicken</h1>
            <div><br></div>
            <h5 class="">Suplier bahan Fried chicken
              baik bahan dasar, ayam potong, bumbu,
              tepung dan peralatan pendukung bisnis Fried Chicken Online</h5>
            <a href="https://wa.me/+6288975731857" target="_blank" class="btn btn-success mt-2 px-4 py-2 text-white"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 18 18">
    ...
    <section class="store-adventeges" id="adventeges">
      <div class="container">
        <div class="row text-center">
          <div class="col-12">
            <h2 class="font-weight-bold mb-2">Ranisa Fried Chicken</h2>
            <hr style="border-top: 5px solid black; width: 80px;">
          </div>
        </div>
        <div class="row text-center">
          <div class="col-md-12">
            <p>Fried Chicken paling lezat yang Terbuat Dari 100%
