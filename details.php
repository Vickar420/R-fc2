            ...
            <div class="row">
              <div class="col-lg-8 d-flex justify-content-between">
                <div>
                  ...
                  <div class="owner"><?= $product["unit"]; ?> Kilogram</div>
                ...
                <div>
                  <p>
                    Tersedia : <strong><?= $product["stock"]; ?> Porsi</strong>
                  </p>
                </div>
              </div>
              <?php if (!isset($_SESSION["login"]) && !isset($_SESSION["user"])) : ?>
                <div class="col-lg-2" data-aos="zoom-in">
                  <a href="login.php" class="btn btn-success px-4 btn-block mb-3 py-2" style=" color: #000; 
  ...
  cursor: pointer;">
              ...
              <?php else : ?>
                <div class="col-lg-2" data-aos="zoom-in">
                  ...
                  <button type="submit" name="addToCart" class="btn btn-success px-4 btn-block mb-3 py-2" style=" color: #000; 
  background: transparent;
  outline: none;
  border: 2px solid #ff9900;
  font-weight: bold;
  ...
  <footer>
    <div class="container">
      <div class="row">
        <div class="col-12">
          <p class="pt-4 pb-2">
            &copy; 2021 Copyright by Ranisa Jagakarsa. All Rights Reserved.
          </p>
        </div>
      </div>
    </div>
