...
<head>
  ...
  <title>Cart | Ranisa Chicker</title>
...
<body>
      ...
      <div class="container">
                ...
                <?php foreach ($carts as $cart) : ?>
                  ...
                  <tr>
                    ...
                    <td style="width: 20%;">
                      ...
                      <div class="product-subtitle"><?= $cart["unit"] / 1; ?> Porsi</div>
                    </td>
                    <td style="width: 10%;">
        ...
        <form action="" method="POST">
          ...
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-4 col-md-3">
              <div class="product-title"><?= $berat / 1; ?> Porsi</div>
              <div class="product-subtitle">Porsi</div>
            </div>
            <div class="col-4 col-md-3">
            ...
            <div class="col-8 col-md-3">
              ...
              <button type="submit" name="checkout" class="btn btn-success btn-block px-4 mt-1" style=" color: #000; 
  background: transparent;
  outline: none;
  border: 2px solid #28a745;
  font-weight: bold;
  cursor: pointer;">Checkout Now</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <footer>
    <div class=" container">
      <div class="row">
        <div class="col-12">
          <p class="pt-4 pb-2">&copy; <?= date('Y'); ?> Copyright by Ranisa Jagakarsa. All Rights Reserved.</p>
        </div>
      </div>
    </div>
  </footer>
